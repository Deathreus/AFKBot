...
public:
	...
	T ChooseFrom(void)
	{
		...
		#if defined _DEBUG
			// problem
			CBotGlobals::BotMessage(NULL, 0, "Bad pointer in queue, (Resetting queue) Memory may have been lost");
		#endif
	...
	T *ChoosePointerFrom(void)
	{
		...
		#if defined _DEBUG
			// problem
			CBotGlobals::BotMessage(NULL, 0, "Bad pointer in queue, (Resetting tasks) Memory may have been lost");
		#endif
